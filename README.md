...
**Stop-Loss Optimization** — profit stabilizes once stop-loss exceeds roughly 14–20%, showing tight stop-losses were often detrimental in this volatile market
...
This project is for educational and research purposes only. All results are based on historical backtesting and simulation; they do not constitute financial advice and are not indicative of live trading performance.
